...
var require_highlight_js_slim = __commonJS((exports) => {
  var __importDefault = exports && exports.__importDefault || function(mod) {
    return mod && mod.__esModule ? mod : { default: mod };
  };
  Object.defineProperty(exports, "__esModule", { value: true });
  exports.hljs = undefined;
...
var require_highlight_js_helpers = __commonJS((exports) => {
  Object.defineProperty(exports, "__esModule", { value: true });
  ...
  function mergeStreams(original, highlighted, value) {
    ...
    function isElement(arg) {
      return arg !== null && (arg === null || arg === undefined ? undefined : arg.attributes) !== undefined;
    }
...
`);
  ...
  function getLanguage(fileExtension) {
    var _a;
    return (_a = languagesToExt[fileExtension]) !== null && _a !== undefined ? _a : "plaintext";
  }
});
...
var require_types = __commonJS((exports) => {
  Object.defineProperty(exports, "__esModule", { value: true });
  exports.ColorSchemeType = exports.DiffStyleType = exports.LineMatchingType = exports.OutputFormatType = exports.LineType = undefined;
  var LineType;
  (function(LineType2) {
...
var require_diff_parser = __commonJS((exports) => {
  Object.defineProperty(exports, "__esModule", { value: true });
  exports.parse = parse;
...
var require_word = __commonJS((exports) => {
  var __extends = exports && exports.__extends || function() {
    var extendStatics = function(d, b) {
      extendStatics = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(d2, b2) {
        d2.__proto__ = b2;
  ...
  Object.defineProperty(exports, "__esModule", { value: true });
  exports.wordsWithSpaceDiff = exports.wordDiff = undefined;
...
var require_sentence = __commonJS((exports) => {
  var __extends = exports && exports.__extends || function() {
    var extendStatics = function(d, b) {
      extendStatics = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(d2, b2) {
        d2.__proto__ = b2;
...
var require_css2 = __commonJS((exports) => {
  var __extends = exports && exports.__extends || function() {
    var extendStatics = function(d, b) {
      extendStatics = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(d2, b2) {
        d2.__proto__ = b2;
...
var require_line_endings = __commonJS((exports) => {
...
var require_distance_iterator = __commonJS((exports) => {
  Object.defineProperty(exports, "__esModule", { value: true });
...
`), hunks = patch.hunks, compareLine = options.compareLine || function(lineNumber, line2, operation, patchContent) {
    ...
    function applyHunk(hunkLines, toPos2, maxErrors2, hunkLinesI, lastContextLineMatched, patchedLines, patchedLinesLength) {
      if (hunkLinesI === undefined) {
        hunkLinesI = 0;
      }
      if (lastContextLineMatched === undefined) {
        lastContextLineMatched = true;
      }
      if (patchedLines === undefined) {
        patchedLines = [];
      }
      if (patchedLinesLength === undefined) {
...
var require_create = __commonJS((exports) => {
  ...
  Object.defineProperty(exports, "__esModule", { value: true });
  exports.OMIT_HEADERS = exports.FILE_HEADERS_ONLY = exports.INCLUDE_HEADERS = undefined;
...
var require_dmp = __commonJS((exports) => {
  Object.defineProperty(exports, "__esModule", { value: true });
...
var require_rematch = __commonJS((exports) => {
  Object.defineProperty(exports, "__esModule", { value: true });
...
var require_render_utils = __commonJS((exports) => {
  ...
  Object.defineProperty(exports, "__esModule", { value: true });
  exports.defaultRenderConfig = exports.CSSLineClass = undefined;
...
var require_file_list_renderer = __commonJS((exports) => {
  var __createBinding = exports && exports.__createBinding || (Object.create ? function(o, m, k, k2) {
    if (k2 === undefined)
      k2 = k;
    var desc = Object.getOwnPropertyDescriptor(m, k);
  ...
  Object.defineProperty(exports, "__esModule", { value: true });
  exports.FileListRenderer = exports.defaultFileListRendererConfig = undefined;
...
var require_line_by_line_renderer = __commonJS((exports) => {
  var __createBinding = exports && exports.__createBinding || (Object.create ? function(o, m, k, k2) {
    if (k2 === undefined)
      k2 = k;
    var desc = Object.getOwnPropertyDescriptor(m, k);
  ...
  Object.defineProperty(exports, "__esModule", { value: true });
  exports.defaultLineByLineRendererConfig = undefined;
  var Rematch = __importStar(require_rematch());
  var renderUtils = __importStar(require_render_utils());
  var types_1 = require_types();
  var utils_1 = require_utils();
...
`);
    ...
    processChangedLines(file, isCombined, oldLines, newLines) {
      ...
      for (let i = 0;i < maxLinesNumber; i++) {
        ...
        const diff = oldLine !== undefined && newLine !== undefined ? renderUtils.diffHighlight(oldLine.content, newLine.content, isCombined, this.config) : undefined;
...
var require_side_by_side_renderer = __commonJS((exports) => {
  var __createBinding = exports && exports.__createBinding || (Object.create ? function(o, m, k, k2) {
    if (k2 === undefined)
      k2 = k;
    var desc = Object.getOwnPropertyDescriptor(m, k);
  ...
  Object.defineProperty(exports, "__esModule", { value: true });
  exports.defaultSideBySideRendererConfig = undefined;
  var Rematch = __importStar(require_rematch());
  var renderUtils = __importStar(require_render_utils());
  var types_1 = require_types();
  var utils_1 = require_utils();
...
`);
    ...
    makeHeaderHtml(blockHeader, file) {
      return this.hoganUtils.render(genericTemplatesPath, "block-header", {
        CSSLineClass: renderUtils.CSSLineClass,
        blockHeader: (file === null || file === undefined ? undefined : file.isTooBig) ? blockHeader : renderUtils.escapeForHtml(blockHeader),
    ...
    generateSingleHtml(line) {
      ...
      return this.hoganUtils.render(genericTemplatesPath, "line", {
        type: (line === null || line === undefined ? undefined : line.type) || `${renderUtils.CSSLineClass.CONTEXT} d2h-emptyplaceholder`,
...
var require_hogan = __commonJS((exports, module) => {
...
var require_diff2html_templates = __commonJS((exports) => {
  var __createBinding = exports && exports.__createBinding || (Object.create ? function(o, m, k, k2) {
    if (k2 === undefined)
      k2 = k;
    var desc = Object.getOwnPropertyDescriptor(m, k);
...
var require_hoganjs_utils = __commonJS((exports) => {
  var __createBinding = exports && exports.__createBinding || (Object.create ? function(o, m, k, k2) {
    if (k2 === undefined)
      k2 = k;
    var desc = Object.getOwnPropertyDescriptor(m, k);
...
var require_diff2html = __commonJS((exports) => {
  var __createBinding = exports && exports.__createBinding || (Object.create ? function(o, m, k, k2) {
    if (k2 === undefined)
      k2 = k;
    var desc = Object.getOwnPropertyDescriptor(m, k);
  ...
  Object.defineProperty(exports, "__esModule", { value: true });
  exports.defaultDiff2HtmlConfig = undefined;
  exports.parse = parse;
  exports.html = html;
...
var require_diff2html_ui_base = __commonJS((exports) => {
  Object.defineProperty(exports, "__esModule", { value: true });
  exports.Diff2HtmlUI = exports.defaultDiff2HtmlUIConfig = undefined;
  ...
  class Diff2HtmlUI {
    ...
    fileContentToggle() {
      this.targetElement.querySelectorAll(".d2h-file-collapse").forEach((fileContentToggleBtn) => {
        ...
        const toggleFileContents = (selector) => {
          var _a;
          const fileContents = (_a = fileContentToggleBtn.closest(".d2h-file-wrapper")) === null || _a === undefined ? undefined : _a.querySelector(selector);
    ...
    isElement(arg) {
      return arg !== null && (arg === null || arg === undefined ? undefined : arg.classList) !== undefined;
    }
  }
...
var require_diff2html_ui_slim = __commonJS((exports) => {
  Object.defineProperty(exports, "__esModule", { value: true });
  exports.defaultDiff2HtmlUIConfig = exports.Diff2HtmlUI = undefined;
...
class ValueObserver {
  ...
  invokeChangedCallbacksForDefaultValues() {
    for (const { key: key2, name, defaultValue, writer } of this.valueDescriptors) {
      if (defaultValue != null && !this.controller.data.has(key2)) {
...
// web/src/controllers/options_controller.ts
class OptionsController extends Controller {
  ...
  async save(event) {
    ...
    const payload = {
      ...
      diff: {
        style: this.diffStyleTarget.value
      }
    };
    try {
...
function applyPromptTemplate(template, values) {
  const replaceToken = (source, token, value) => source.split(token).join(value);
  let result = template;
...
function buildHrefMap(outputEl) {
  const hrefMap = new Map;
  outputEl.querySelectorAll(".d2h-file-list a.d2h-file-name").forEach((a) => {
    const name = a.textContent?.trim();
    if (name && a.hash)
      hrefMap.set(name, a.hash);
  });
  return hrefMap;
}
...
function renderTreeLevel(parent, tree, hrefMap, depth) {
  ...
  for (const [name, subtree] of folders) {
    parent.appendChild(el("div", { style: indent }, [
      el("span", {
        className: "flex items-center text-[10px] font-medium uppercase tracking-wide text-gray-400 gap-1.5 py-1",
        textContent: `${name}`
      })
    ]));
  ...
  for (const [name, fullPath] of files) {
    const link = el("a", {
      className: "block truncate rounded-md px-2 py-1 text-xs text-gray-600 transition-colors hover:text-gray-900 hover:bg-gray-50 flex-1",
      textContent: name,
      href: hrefMap.get(fullPath) ?? ""
    });
    parent.appendChild(el("div", { className: "flex items-center gap-1 group", style: indent }, [
      link
    ]));
  }
}
function renderFileTree(container, outputEl, files) {
  ...
  container.appendChild(el("h3", {
    className: "text-[10px] font-medium uppercase tracking-wide text-gray-400 mb-3 mt-1",
    textContent: "Files"
  }));
  container.appendChild(treeContainer);
}
function renderCommentIndicators(outputEl, comments, popupSignal, onDelete) {
  outputEl.querySelectorAll(".towelie-comment-btn").forEach((el2) => {
    if (el2.tagName === "TR") {
      el2.querySelectorAll(".d2h-code-side-linenumber").forEach((ln) => {
        ln.style.backgroundColor = "";
      });
      el2.classList.remove("towelie-comment-btn");
    } else {
      el2.remove();
    }
  });
  ...
  if (comments.length === 0)
    return;
  const fileWrappers = Array.from(outputEl.querySelectorAll(".d2h-file-wrapper"));
  for (const comment of comments) {
    ...
    for (const wrapper of fileWrappers) {
      ...
      if (wrapperFileName !== fileName)
        continue;
      const filesDiv = wrapper.querySelector(".d2h-files-diff");
      if (!filesDiv)
        continue;
      const sides = Array.from(filesDiv.querySelectorAll(":scope > .d2h-file-side-diff"));
      const sideContainer = diffSide === "old" /* Old */ ? sides[0] : sides[1];
      if (!sideContainer)
        continue;
      const { endLine } = comment.selection;
      const lineNumberEls = Array.from(sideContainer.querySelectorAll(".d2h-code-side-linenumber"));
      let firstRow = null;
      for (const lineEl of lineNumberEls) {
        const num = Number(lineEl.textContent);
        if (isNaN(num) || num < startLine || num > endLine)
          continue;
...
class ReviewController extends Controller {
  ...
  activeForm = null;
  commentPopupAbortController = null;
  selectionState = {
    start: null,
    rows: new Set,
    row: null,
  ...
  disconnect() {
    this.outputTarget.removeEventListener("mousedown", this.HighlightSelectedLine);
    this.outputTarget.removeEventListener("mousemove", this.highlightLineNumber);
  ...
  async reloadReview() {
    ...
    const outputFormat = options.diff.style === "inline" ? "line-by-line" : "side-by-side";
    this.outputTarget.innerHTML = "";
    const diff2htmlUi = new import_diff2html_ui_slim.Diff2HtmlUI(this.outputTarget, diff.diff.diff, {
      drawFileList: true,
      matching: "lines",
      outputFormat,
    ...
    diff2htmlUi.draw();
    this.outputTarget.querySelectorAll(".d2h-file-wrapper").forEach((wrapper) => {
  ...
  async populateInfo() {
    ...
    branchNames.forEach((branchName) => {
      if (branchName === info.current_branch)
        return;
    ...
    branchSelect.value = savedBranch && branchNames.includes(savedBranch) ? savedBranch : "";
...
${commentsBlock}` : commentsBlock;
  ...
  decorateLineNumbersAndRenderComments() {
    ...
    const lineNumbers = this.outputTarget.querySelectorAll(".d2h-code-side-linenumber");
    lineNumbers.forEach((el2) => {
      el2.classList.add("towelie-commentable");
      if (!el2.title) {
        el2.title = "Click or drag to add a comment";
      }
    });
    const branch = this.branchSelectTarget.value || "current";
    renderCommentIndicators(this.outputTarget, this.storage.forBranch(branch), this.commentPopupAbortController.signal, (comment) => {
  ...
  updateSelectionHighlight() {
    ...
    const wrappers = Array.from(this.outputTarget.querySelectorAll(".d2h-file-wrapper"));
  ...
  highlightLineNumber = (e) => {
    if (!this.selectionState.selecting || !this.selectionState.start)
      return;
    const context = this.getLineContext(e.target);
    if (!context)
      return;
  ...
  ConfirmCommentSelection = () => {
    ...
    this.selectionState.start = null;
    this.activeForm = showInlineCommentForm(this.selectionState.row, normalized, (selection, text) => {
      const branch = this.branchSelectTarget.value || "current";
